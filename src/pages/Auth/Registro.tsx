...
export default function Registro() {
  ...
  const handleDiscordLogin = async () => {
    try {
      ...
      setError(err.message || 'Error al continuar con Discord');
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (existingUser) throw new Error('Ese nombre de usuario ya está en uso');

      const { data, error: signUpError } = await supabase.auth.signUp({
        email: formData.email.trim(),
        password: formData.password,
        options: { data: { username: formData.username.trim() } },
      });
      ...
      setError(err.message.includes('User already registered')
        ...
        <div className="registro-card">
          ...
          <form onSubmit={handleSubmit} className="registro-form">
            ...
            <label className="terms-checkbox">
              ...
              <span>
                Acepto los{' '}
                <Link to="/terminos" className="terms-link">Términos y Condiciones</Link>
                {' '}y la{' '}
                <Link to="/privacidad" className="terms-link">Política de Privacidad</Link>
              </span>
            </label>
          ...
          <div className="registro-divider"><span>o regístrate con</span></div>
          ...
          <div className="social-login">
            ...
            >
              {loadingGoogle ? <span>Conectando...</span> : (
                <>
            ...
            <button
              ...
              disabled={isAnyLoading}
            >
              {loadingDiscord ? <span>Conectando...</span> : (
                <>
