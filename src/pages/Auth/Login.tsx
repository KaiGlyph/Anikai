  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (authResult.error) {
        ...
        if (msg.includes('Invalid login credentials')) throw new Error('Email/usuario o contraseña incorrectos');
        if (msg.includes('Email not confirmed')) throw new Error('Debes verificar tu email antes de iniciar sesión');
        throw new Error(msg);
      }
